        ...
        <div class="container">
            <div class="col-md-6 col-left-sec"  style="padding-top:50px">
                <div class="panel panel-default">
                    ...
                    <h3>Sign in to Travel-Mate securely</h3></div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
	                    <label class="no-capitalize">Don't have Travel-Mate Account? Create it now!</label>
	                    <br />
                        <asp:Button ID="Button1" runat="server" Text="Register Here" CssClass="btn btn-info" PostBackUrl="~/custsignup.aspx" />
                    </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 hidden-xs col-right-sec" style="padding-top:50px">
                <h3>Why Sign in?</h3>
                <div class="row">
                    <div class="col-md-10">
                        <ul>
                            <li><i class="fa fa-edit" style="font-size:30px;"></i> Book faster with pre-filled forms</li>
                            <br />
                            <li><i class="fa fa-hourglass" style="font-size:30px;"></i> Check booking history</li>
                           <br />
                            <li><i class="fa fa-money" style="font-size:30px;"></i> Manage cancellation &amp; refunds</li>
					...
					<div class="footer-right">
						<div class="footer-nav">
							<ul>
								...
								<li><a href="custbooking.aspx">BOOKING</a></li>  
								<li><a href="custgallery.aspx">GALLERY</a></li>  
								<li><a href="custsignup.aspx">SIGN-UP</a></li>  
							</ul>
						</div>
					</div>
					<div class="clearfix"> </div>
